...
<div class="box">
	<div class='is-flex is-flex-direction-row is-justify-content-space-between'>
		<h5 class='has-text-weight-bold mb-2 is-size-5'>Edit Product</h5>
	...
	<form action="{{ route('product.update', $product->id) }}" method='post' enctype="multipart/form-data">
		...
		<div class="columns is-multiline">
			<div class="column is-4">
			  ...
			  <div class="control">
			    <input class="input @error('name') is-danger @enderror" type="text" name="name" placeholder="e.g Bread" value="{{ $product->name }}">
			  </div>
			...
			<div class="column is-4">
			  ...
			  <div class="control">
			    <input class="input @error('buying_price') is-danger @enderror" type="number" name="buying_price" value="{{ $product->buying_price }}">
			  </div>
			...
			<div class="column is-4">
			  ...
			  <div class="control">
			    <input class="input @error('selling_price') is-danger @enderror" type="number" name="selling_price" value="{{ $product->selling_price }}">
			  </div>
			...
			<div class="column is-12">
			  ...
			  <div class="control">
			  	<textarea name="description" rows="4" class="textarea @error('name') is-danger @enderror">{{ $product->description }}</textarea>
			  </div>
